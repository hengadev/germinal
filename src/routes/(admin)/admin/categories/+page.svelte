...
{#snippet createInput(fieldName: string)}
 ...
 class="w-12 h-10 border border-border-input rounded-lg cursor-pointer"
 />
 <input
 name="color"
 type="text"
...
<div class="container mx-auto px-4 py-8 lg:py-12">
 ...
 <h1 class="text-3xl lg:text-4xl font-bold mb-2">Catégories d'Événements</h1>
            <p class="text-muted-foreground">Gérez les catégories d'événements pour le filtrage</p>
 </div>
 <button
 ...
 >
 <Plus size={18} />
 <span class="whitespace-nowrap">Créer une Catégorie</span>
 </button>
 </div>
 {:else}
 <!-- Table view -->
 ...
 {:else}
 <div
 class="w-10 h-10 bg-muted rounded-lg flex items-center justify-center"
 >
