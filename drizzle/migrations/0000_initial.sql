...
CREATE INDEX "email_queue_status_attempts_last_attempt_idx" ON "email_queue" USING btree ("status", "attempts", "last_attempt_at");
...
CREATE INDEX "event_sessions_published_start_time_idx" ON "event_sessions" USING btree ("published", "start_time");
...
CREATE INDEX "media_is_cover_idx" ON "media" USING btree ("is_cover");
...
CREATE INDEX "payments_webhook_processed_idx" ON "payments" USING btree ("webhook_processed_at") WHERE webhook_processed_at IS NULL;
...
CREATE INDEX "reservations_status_created_at_idx" ON "reservations" USING btree ("status", "created_at");
...
CREATE UNIQUE INDEX "events_spotlight_unique_idx" ON "events" USING btree ("is_spotlight") WHERE is_spotlight = true;
